...
const sizeClasses = {
  sm: "text-8xl md:text-xl",
  md: "text-8xl md:text-2xl lg:text-3xl",
  lg: "text-8xl md:text-3xl lg:text-4xl xl:text-5xl",
  xl: "text-8xl md:text-4xl lg:text-5xl xl:text-6xl",
  "2xl": "text-8xl md:text-5xl lg:text-6xl xl:text-7xl",
};
